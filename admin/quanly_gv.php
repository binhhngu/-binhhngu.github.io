...
$query -> execute();
$_SESSION['delmsg']="Xóa giáo viên thành công";
...
<head>
    ...
    <title>Ouản Lý Học Viên | Quản Lý Giáo Viên</title>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Quản lý giáo viên</h4>
                </div>
                <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->magv);?></td>
                                            ...
                                            <td class="center">
                                                <a href="sua_gv.php?idgv=<?php echo htmlentities($result->id);?>">
                                                    <button class="btn btn-primary"><i class="fa fa-edit"></i> Chỉnh
                                                        Sửa</button>
                                                </a>
                                                <a href="quanly_gv.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn chắc chắn muốn xóa?');">
