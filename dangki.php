...
include('includes/config.php');
    ...
    // Thực hiện câu truy vấn SQL để lấy thông tin các lớp học đang mở
...
<head>
    ...
    <title>Quản Lý Học Viên | Danh Sách Lớp Học Đang Mở</title>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Danh Sách Lớp Học Đang Mở</h4>
                </div>
                <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->siso_hientai);?>/<?php echo htmlentities($result->siso);?></td>
                                            
                                            
                                            
                                            <td class="center">
                                                
                                                <a href="thongtin_dk.php?malop=<?php echo htmlentities($result->malop);?>" >
                                                    <button class="btn btn-success"><i class="fa fa-pencil"></i> Đăng Kí</button>
                                                </a>
